...
oneTimeCode UITextField for iOS (2FA, second factor)
                     DESC
  ...
  # Or just: spec.author    = "Andrii Drobiazko"
  # spec.authors            = { "Andrii Drobiazko" => "c2q9450@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Andrii Drobiazko"
